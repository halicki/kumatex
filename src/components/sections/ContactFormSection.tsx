  ...
  return (
    <section className="w-full bg-light-gray">
      <div className="mx-auto flex max-w-[1440px]">
        <div className="relative h-[714px] w-[709px] shrink-0">
        ...
        <div className="flex flex-1 flex-col justify-center px-16 py-8">
          <h2 className="mb-8 font-[family-name:var(--font-roboto)] text-5xl font-black text-dark">
            Kontakt
          </h2>
          {submitted ? (
